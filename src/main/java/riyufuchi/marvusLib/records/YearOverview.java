...
public record YearOverview(int year, BigDecimal[] income, BigDecimal[] spendigs, BigDecimal[] outcomes,  BigDecimal totalIncome, BigDecimal totalSpendings, BigDecimal totalResult)
{
	@Deprecated
